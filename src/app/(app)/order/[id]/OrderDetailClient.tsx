...
import { ArrowLeft, Package, MapPin, Clock, Info, CheckCircle2, User, Phone, Map, Edit, XCircle } from "lucide-react";
    ...
    return (
        <PageContainer className="max-w-7xl mx-auto space-y-6 pb-20 sm:pb-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2 mt-4 sm:mt-0 ml-8 sm:ml-0">
                    ...
                    {(userRole === "admin" || (userRole === "user" && order.status === "pending")) && order.status !== "cancelled" && (
                        ...
                        >
                            <Button variant="destructive" size="sm" className="h-9" disabled={isPending}>
